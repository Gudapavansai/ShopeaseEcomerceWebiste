    ...
    return (
        <div>
            ...
            <div className='text-2xl text-center pt-8 border-t'>
                <Title title1={'ABOUT'} text2={'US'} />
            </div>

            <div className='my-10 flex flex-col md:flex-row gap-16'>
                <img className='w-full md:max-w-[450px]' src={assets.aboutImg} alt="Modern clothing boutique interior with stylish display" />
            ...
            <div className='text-xl py-4'>
                <Title title1={'WHY'} text2={'CHOOSE US'} />
            </div>
